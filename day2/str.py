...
print('i am %s' % ('tom',))
print('i am %s' % 'comyn')
print('i am %s， %s old' % ('tomcat', '19'))

## fromat 方法
print('i am {}'.format('tom'))
# 'i am tom'
print('i am {}, my age is {}'.format('tomat',18))
# 'i am tomat, my age is 18'
print('i am {1}, my age is {0}'.format(18, 'tomm'))
# 'i am tomm, my age is 18'
print('i am {name}, my age is {age}.'.format(name='tomy',age=18))
# 'i am tomy, my age is 18.'
print('my name is {}, i am {age} years old, i am a {}'.format('tom','boy',age=19))
# 'my name is tom, i am 19 years old, i am a boy'

# 左右对齐
print('{0:80}'.format('zenghui'))
# 'zenghui                                                                         '
print'{0:>80}'.format('zenghui'))
# '                                                                         zenghui'
print('{0:<80}'.format('zenghui'))
...
## python3中，bytes 和str的区别在于bytes是byte的序列， 而str是unicode的序列
## str 使用encode方法转换为bytes，bytes通过decode转化为str
